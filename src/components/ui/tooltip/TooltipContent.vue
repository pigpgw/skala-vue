...
const props = defineProps({
  ...
  sticky: {
    type: /** @type {import('vue').PropType<'partial' | 'always'>} */ (String),
    required: false,
  },
  hideWhenDetached: { type: Boolean, required: false },
  positionStrategy: {
    type: /** @type {import('vue').PropType<'fixed' | 'absolute'>} */ (String),
    required: false,
  },
  updatePositionStrategy: {
    type: /** @type {import('vue').PropType<'always' | 'optimized'>} */ (String),
    required: false,
  },
  class: {
